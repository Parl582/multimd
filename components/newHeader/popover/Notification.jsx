...
const NotificationPopOver = ({ selectedLanguage }) => {
  return (
    <>
      <Popover>
        <PopoverTrigger>
          <div className="relative !bg-white z-50 mt-2">
            <BellRing
              strokeWidth={0.9}
              className="md:mx-2 mx-1 cursor-pointer"
            />
        ...
        <PopoverContent className="w-[400px] max-h-96 bg-white z-[9999]  overflow-y-auto  mt-5 mx-0 p-0 rounded-md overflow-x-hidden shadow-lg ">
